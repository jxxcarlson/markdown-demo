...
{
	if (region.a0.bt === region.be.bt)
	{
		return 'on line ' + region.a0.bt;
	}
	return 'on lines ' + region.a0.bt + ' through ' + region.be.bt;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bi: fragment, bl: host, by: path, bA: port_, bE: protocol, bF: query};
	});
...
var $author$project$Main$init = function (flags) {
	var model = {F: 0, a_: 0, W: $author$project$Strings$initialText};
		...
		switch (msg.$) {
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{F: model.F + 1, W: $author$project$Strings$initialText}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor = function (background) {
	return {al: background, _: false, aa: false, an: false, aR: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$DefaultColor};
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$noEmphasis = F2(
	function (text, background) {
		return {al: background, _: false, aa: false, an: false, aR: text};
	});
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor = function (text) {
	return {al: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$DefaultColor, _: false, aa: false, an: false, aR: text};
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$requiredStyles = {
	b2: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#003800')),
	b9: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
	...
	cl: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#343434')),
	cE: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#ae81ff')),
	cF: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#e6db74')),
	cG: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#f92672')),
	cH: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#66d9ef')),
	cI: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#a6e22e')),
	cJ: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#ae81ff')),
	cK: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$theme = {
	...
	cz: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$requiredStyles
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Type$toCss = function (_v0) {
	...
	var customStyles = _v0.cb;
	return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$toCss(
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2('.elmsh', requiredStyles.cc),
					_Utils_Tuple2('.elmsh-hl', requiredStyles.cl),
					_Utils_Tuple2('.elmsh-add', requiredStyles.b2),
					_Utils_Tuple2('.elmsh-del', requiredStyles.cd),
					_Utils_Tuple2('.elmsh-comm', requiredStyles.b9),
					_Utils_Tuple2('.elmsh1', requiredStyles.cE),
					_Utils_Tuple2('.elmsh2', requiredStyles.cF),
					_Utils_Tuple2('.elmsh3', requiredStyles.cG),
					_Utils_Tuple2('.elmsh4', requiredStyles.cH),
					_Utils_Tuple2('.elmsh5', requiredStyles.cI),
					_Utils_Tuple2('.elmsh6', requiredStyles.cJ),
					_Utils_Tuple2('.elmsh7', requiredStyles.cK)
				]),
			A2(
				$elm$core$List$map,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a7: col, bB: problem, bL: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bL, p.a7, p.bB);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a7: 1, d: _List_Nil, f: 1, b: 0, bL: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$newLine = function (fragments) {
	return {ci: fragments, cl: $elm$core$Maybe$Nothing};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toFragment = F2(
	function (toStyle, _v0) {
		...
		switch (syntax.$) {
			case 0:
				return {b3: '', cy: 0, aR: text};
			case 1:
				return {b3: '', cy: 1, aR: text};
			case 2:
				return {b3: '', cy: 0, aR: text};
			default:
				var c = syntax.a;
				...
				return {b3: additionalClass, cy: requiredStyle, aR: text};
		}
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a7: col, ca: contextStack, bB: problem, bL: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bL, s.a7, x, s.d));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{a7: 1, d: s.d, f: s.f, b: s.b + 1, bL: s.bL + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{a7: s.a7 + 1, d: s.d, f: s.f, b: newOffset, bL: s.bL, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{a7: col, d: s0.d, f: s0.f, b: offset, bL: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bL, s.a7, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bL, s.a7, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{a7: newCol, d: s.d, f: s.f, b: newOffset, bL: newRow, a: s.a});
	};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimitedUnnestable = F2(
	function (options, revAList) {
		var defaultMap = options.bc;
		var isNotRelevant = options.bq;
		var end = options.be;
		var innerParsers = options.bn;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimitedHelp = F2(
	function (options, revAList) {
		...
		var _v0 = _Utils_Tuple2(
			...
			$elm$core$String$uncons(options.be));
		if (_v0.a.$ === 1) {
			var _v1 = _v0.a;
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.bL, s.a7, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Sql$multilineComment = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	{
		...
		bp: false,
		bq: A2($elm$core$Basics$composeL, $elm$core$Basics$not, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak),
		a0: '/*'
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {cn: index, aq: match, ct: number, bS: submatches};
	});
			...
			case 9:
				...
				if (op === 'class') {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('X10')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2(
									$elm$core$String$join,
									' ',
									A2($elm$core$List$cons, 'op(' + (op + ')'), args)))
							]));
				}
			case 11:
...
var $jxxcarlson$elm_markdown$Markdown$Render$renderOrdinary = F5(
	function (info, selectedId, id, level, blockContent) {
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('X7')
				]),
			_List_fromArray(
				[
...
var $Garados007$elm_svg_parser$SvgParser$elementToSvg = function (element) {
	return A3(
		$elm$svg$Svg$node,
		element.aN,
		A2($elm$core$List$map, $Garados007$elm_svg_parser$SvgParser$toAttribute, element.aT),
	...
	return $andre_dietrich$parser_combinators$Combine$primitive(
		F2(
			function (state, stream) {
				...
				var _v0 = $elm$core$String$uncons(stream.y);
				if (!_v0.$) {
					var _v1 = _v0.a;
					var h = _v1.a;
					var rest = _v1.b;
...
var $andre_dietrich$parser_combinators$Combine$string = function (s) {
	return F2(
		function (state, stream) {
			if (A2($elm$core$String$startsWith, s, stream.y)) {
				var len = $elm$core$String$length(s);
				var pos = stream.N + len;
				var rem = A2($elm$core$String$dropLeft, len, stream.y);
				return _Utils_Tuple3(
					state,
					_Utils_update(
						stream,
...
var $Garados007$elm_svg_parser$SvgParser$Element = F3(
	function (name, attributes, children) {
		return {aT: attributes, aC: children, aN: name};
	});
	...
	var childrenParser = A2(
		...
		A2(
			...
			A2(
				...
				$andre_dietrich$parser_combinators$Combine$whitespace),
			$andre_dietrich$parser_combinators$Combine$string('</' + (element.aN + '>'))));
...
var $andre_dietrich$parser_combinators$Combine$InputStream = F3(
	function (data, input, position) {
		return {ba: data, y: input, N: position};
	});
...
var $Garados007$elm_svg_parser$SvgParser$parse = function (input) {
	var toHtml = function (svgNode) {
		if (!svgNode.$) {
			var element = svgNode.a;
			return (element.aN === 'svg') ? $elm$core$Result$Ok(
				A2(
					$elm$svg$Svg$svg,
					A2($elm$core$List$map, $Garados007$elm_svg_parser$SvgParser$toAttribute, element.aT),
					A2($elm$core$List$map, $Garados007$elm_svg_parser$SvgParser$nodeToSvg, element.aC))) : $elm$core$Result$Err('Top element is not svg');
		} else {
			...
			switch (block.a.a.$) {
				...
				default:
					...
					if (_v17 === 'svg') {
						...
						return A5($jxxcarlson$elm_markdown$Markdown$Render$renderOrdinary, info, selectedId, id, level, blockContent);
					}
			}
		}
	});
		...
		while (true) {
			...
			if (!_v0.b) {
				...
				if (!_v0.a.b.b) {
					...
					var $temp$f = f,
						$temp$state = state_,
						$temp$acc = {c: _List_Nil, cq: label_, k: cs},
						$temp$stack = A2(
						$elm$core$List$cons,
						_Utils_update(
							acc,
...
var $jxxcarlson$elm_markdown$BlockType$Plain = {$: 8};
...
var $jxxcarlson$elm_markdown$MDInline$alphaNumSpace = $jxxcarlson$elm_markdown$MDInline$parseWhile(
	function (c) {
...
var $jxxcarlson$elm_markdown$MDInline$makeList = function (str) {
	return A2(
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.bL, s.a7, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $jxxcarlson$elm_markdown$MDInline$extension = A2(
	...
	A2(
		...
		A2(
			$elm$parser$Parser$Advanced$ignorer,
			A2($elm$parser$Parser$Advanced$map, $jxxcarlson$elm_markdown$MDInline$makeList, $jxxcarlson$elm_markdown$MDInline$alphaNumSpace),
			$elm$parser$Parser$Advanced$symbol(
...
var $jxxcarlson$elm_markdown$MDInline$PrefixedString = F2(
	function (prefix, text) {
		return {ag: prefix, aR: text};
	});
var $jxxcarlson$elm_markdown$MDInline$image = A2(
	$elm$parser$Parser$Advanced$map,
	function (ps) {
		return A2($jxxcarlson$elm_markdown$MDInline$Image, ps.ag, ps.aR);
	},
	A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
...
var $jxxcarlson$elm_markdown$MDInline$linkOrBracket = function (ps) {
	var _v0 = ps.aR;
	if (_v0 === ' ') {
		return $jxxcarlson$elm_markdown$MDInline$BracketedText(ps.ag);
	} else {
		return A2($jxxcarlson$elm_markdown$MDInline$Link, ps.aR, ps.ag);
	}
};
...
var $jxxcarlson$elm_markdown$MDInline$wrapper = F2(
	function (str, acc) {
		return (acc.C === '') ? {C: str, ad: _List_Nil} : ($jxxcarlson$elm_markdown$MDInline$endsWithPunctuation(acc.C) ? {
			C: str,
			ad: A2($elm$core$List$cons, acc.C, acc.ad)
		} : _Utils_update(
			acc,
			{C: acc.C + (' ' + str)}));
	});
var $jxxcarlson$elm_markdown$MDInline$wrap = function (strList) {
	return $elm$core$List$reverse(
		function (acc) {
			return A2($elm$core$List$cons, acc.C, acc.ad);
		}(
			A3(
				$elm$core$List$foldl,
...
var $zwilias$elm_rosetree$Tree$Zipper$fromTree = function (t) {
	return {aB: _List_Nil, aU: _List_Nil, p: _List_Nil, g: t};
};
		...
		return $elm$core$Maybe$Just(
			{
				...
				aU: crumb.aU,
				p: rest,
				g: A4($zwilias$elm_rosetree$Tree$Zipper$reconstruct, zipper.g, zipper.aU, zipper.aB, crumb.cq)
			});
	}
};
		...
		return $elm$core$Maybe$Just(
			{
				...
				p: A2(
					$elm$core$List$cons,
					{
						aB: zipper.aB,
						aU: zipper.aU,
						cq: $zwilias$elm_rosetree$Tree$label(zipper.g)
					},
					zipper.p),
				g: c
			});
...
var $zwilias$elm_rosetree$Tree$Zipper$previousSibling = function (_v0) {
	...
	if (!_v1.b) {
		...
		return $elm$core$Maybe$Just(
			{
				aB: A2($elm$core$List$cons, zipper.g, zipper.aB),
				aU: rest,
				p: zipper.p,
				g: previous
			});
...
var $jxxcarlson$elm_markdown$BlockType$Table = {$: 13};
var $jxxcarlson$elm_markdown$BlockType$TableRow = {$: 12};
...
var $jxxcarlson$elm_markdown$Markdown$Parse$topOfBlockStack = function (register) {
	return $elm$core$List$head(register.o);
};
		...
		if (((!_v1.$) && (_v1.a.$ === 1)) && (_v1.a.a.$ === 12)) {
			...
			var tableData = A2(
				...
				function (x) {
					...
					$elm$core$List$reverse(register.o)));
			var newBlocks = A2(
				$elm$core$List$filter,
				function (_v3) {
					var content = _v3.d;
...
var $jxxcarlson$elm_markdown$BlockType$Blank = {$: 10};
...
var $jxxcarlson$elm_markdown$BlockType$Image = {$: 9};
...
var $jxxcarlson$elm_markdown$BlockType$Poetry = {$: 7};
...
var $jxxcarlson$elm_markdown$BlockType$TableCell = {$: 11};
	...
	function (line, _v0) {
		...
		switch (state_.$) {
			...
			case 2:
				return A3($jxxcarlson$elm_markdown$Markdown$Parse$FSM, state_, blocks_, register);
			default:
				var _v2 = $elm$core$List$head(register.o);
				if (_v2.$ === 1) {
					return A3(
						$jxxcarlson$elm_markdown$Markdown$Parse$FSM,
					...
					return A3(
						...
						_Utils_update(
							register,
							{
								o: A2($elm$core$List$drop, 1, register.o)
							}));
				}
		}
	});
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($jxxcarlson$elm_markdown$Markdown$Render$toHtml, 2, model.W)))
			]));
};
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{co: $author$project$Main$init, cL: $author$project$Main$subscriptions, cO: $author$project$Main$update, cQ: $author$project$Main$view});
